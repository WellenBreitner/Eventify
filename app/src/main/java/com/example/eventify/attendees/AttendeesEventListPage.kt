...
class AttendeesEventListPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        events.add(EventModelData(null, "1", "Annual Beach Cleanup and Marine Protection Drive",
            ...
            "2025-04-05 08:00", "damansara HELP University",true,"org1"))

        events.add(EventModelData(null, "2", "Comprehensive Turtle Nesting Awareness and Conservation Workshop",
            ...
            "2025-04-10 10:30", "damansara HELP University",true,"org2"))

        events.add(EventModelData(null, "3", "Fundraising Gala and Charity Dinner for Global Turtle Conservation Efforts",
            ...
            "2025-04-15 19:00", "damansara HELP University",false,"org3"))

        events.add(EventModelData(null, "4", "International Webinar on Advanced Turtle Conservation Strategies",
            ...
            "2025-04-20 14:00", "damansara HELP University",false,"org4"))

        events.add(EventModelData(null, "5", "Marine Life Protection Campaign and Educational Workshop",
            ...
            "2025-04-25 09:00", "damansara HELP University",true,"org5"))

        events.add(EventModelData(null, "6", "Underwater Cleanup Dive: Preserving Ocean Habitats",
            ...
            "2025-05-01 07:30", "damansara HELP University",true,"org6"))

        events.add(EventModelData(null, "7", "Turtle Rehabilitation Program: Healing and Conservation Efforts",
            ...
            "2025-05-05 13:00", "damansara HELP University",true,"org7"))

        events.add(EventModelData(null, "8", "Eco-Friendly Living Workshop: Sustainable Habits for a Healthier Planet",
            ...
            "2025-05-10 11:00", "damansara HELP University",false,"org8"))

        events.add(EventModelData(null, "9", "Turtle Migration Awareness Walk: Protecting the Paths of Endangered Species",
            ...
            "2025-05-15 16:30", "damansara HELP University",true,"org9"))

        events.add(EventModelData(null, "10", "Sea Turtle Festival: Celebrating Conservation Through Culture and Community",
            ...
            "2025-05-20 18:00", "damansara HELP University",true,"org10"))
